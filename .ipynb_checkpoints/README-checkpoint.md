...
This README provides an overview of building a DIY RAG system using Gemini
...
## The RAG_VertexSearch  
### notebook demonstrates how to build a Retrieval Augmented Generation (RAG) system using Vertex AI  
